...
import { CheckCircle, Download, UserPlus, Home, FileText, Calendar } from "lucide-react"
...
export function RegistrationSuccess({ registrationData, onNewRegistration }: RegistrationSuccessProps) {
              ...
              <div class="patient-info">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <div class="value">${registrationData.gender === "male" ? "पुरुष | Male" : "महिला | Female"}</div>
                  </div>
                  <div class="info-item">
                  ...
                  <div class="info-item">
                    ...
                    <div class="value">${registrationData.guardianName || registrationData.fatherName}</div>
                  </div>
                  <div class="info-item">
                    <div class="label">ठेगाना | Address</div>
                    <div class="value">${registrationData.district}, ${registrationData.palika}-${registrationData.ward}</div>
                  </div>
                </div>
              </div>
      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="p-8">
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">{registrationData.childName} को दर्ता सम्पन्न भयो</h2>
            <p className="text-gray-600">स्वर्णबिन्दु प्राशन कार्यक्रममा सफलतापूर्वक दर्ता गरिएको छ।</p>
          </div>
          ...
          <Card className="border-green-200 bg-green-50 mb-6">
            <CardContent className="p-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-medium text-green-800">दर्ता नम्बर:</span>
                  <p className="font-mono text-green-900">#{serialNumber}</p>
                </div>
                <div>
                  <span className="font-medium text-green-800">मिति:</span>
                  <p className="text-green-900">{new Date().toLocaleDateString("ne-NP")}</p>
                </div>
                <div>
                  <span className="font-medium text-green-800">उमेर:</span>
                  <p className="text-green-900">{calculateAge(registrationData.dateOfBirth)}</p>
                </div>
                <div>
                  <span className="font-medium text-green-800">मात्रा:</span>
                  <p className="text-green-900">{registrationData.doseAmount} थोपा</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="flex justify-center mb-6">
            <Badge variant={isOnline ? "default" : "secondary"} className="px-4 py-2">
              {isOnline ? "Online - Database मा सेभ भयो" : "Offline - स्थानीय रूपमा सेभ भयो"}
            </Badge>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <Button onClick={generateCertificate} className="flex items-center gap-2 bg-transparent" variant="outline">
              <Download className="h-4 w-4" />
              प्रमाणपत्र डाउनलोड
            </Button>

            <Button onClick={onNewRegistration} className="flex items-center gap-2">
          ...
          {certificateGenerated && (
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-center">
              ...
              <p className="text-blue-800 text-sm">प्रमाणपत्र सफलतापूर्वक जेनेरेट भयो!</p>
            </div>
          )}
        </CardContent>
      </Card>
