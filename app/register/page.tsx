      ...
      <RegistrationSuccess
        ...
        onNewRegistration={() => {
          ...
          setRegistrationData({
            ...
            guardianName: "",
            contactNumber: "",
            district: registrationData.district, // Keep location data for speed
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">नयाँ दर्ता | New Registration</h1>
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-green-800">आजको दर्ता</p>
                  <p className="text-2xl font-bold text-green-900">{todayStats.registered}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-yellow-200 bg-yellow-50">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-yellow-800">सिंक पेन्डिङ</p>
                  <p className="text-2xl font-bold text-yellow-900">{todayStats.pending}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-200 bg-blue-50">
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-blue-800">लक्ष्य प्रगति</p>
              ...
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center">
                  <div className="flex flex-col items-center">
                    {getStepIcon(step)}
                    <span className="text-xs mt-2 font-medium text-center max-w-20">{getStepTitle(step)}</span>
                  </div>
                  {step < 3 && (
                    <div
                      className={`h-1 w-24 mx-4 rounded-full ${step < currentStep ? "bg-green-500" : "bg-gray-300"}`}
                    />
                  )}
                </div>
              ))}
        ...
        {!isOnline && (
          <Alert className="mb-6">
            ...
            <AlertDescription>
              तपाईं अफलाइन काम गर्दै हुनुहुन्छ। डाटा स्थानीय रूपमा सेभ हुनेछ र इन्टरनेट जडान भएपछि सिंक हुनेछ।
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="max-w-4xl mx-auto">
          {currentStep === 1 && (
            <RegistrationStep1 data={registrationData} onUpdate={updateRegistrationData} onNext={nextStep} />
          )}
          {currentStep === 2 && (
            <RegistrationStep2
